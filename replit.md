...
- Adjusted header height to 120px to better accommodate large 240px logo while reducing empty space (February 5, 2025)
...
- Updated all page padding to accommodate 120px fixed header size
- Fixed header layout to ensure navigation items are fully visible with proper spacing
