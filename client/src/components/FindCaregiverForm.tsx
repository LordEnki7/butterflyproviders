...
export default function FindCaregiverForm() {
  ...
  const caregiverMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "We'll contact you soon to help you find a caregiver.",
      });
      setFormData({
        name: '',
        email: '',
  ...
  return (
    <section id="find-caregiver" className="py-16 bg-gradient-to-br from-emerald-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Let us connect you with a compassionate caregiver who can help you or your loved one.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <label htmlFor="agreeToContact" className="text-sm text-gray-700 leading-relaxed">
                    ...
                    regarding my care request and updates. 
                ...
                <Button 
                  type="submit"
                  disabled={caregiverMutation.isPending || !formData.agreeToContact}
                ...
                >
                  {caregiverMutation.isPending ? 'Submitting...' : 'Find a Caregiver'}
                </Button>
